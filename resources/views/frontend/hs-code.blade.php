        ...
        <div class="container-fluid pdt-2 pdt-2">
            ...
            <div class="container">
                <div class="row bg-green" style="border-radius: 1rem;">
                    ...
                    <form class="form-flex" action="{{ route('searchHSCode', ['description' => request()->input('description'), 'hs-code' => request()->input('hs-code')]) }}" method="get" enctype="multipart/form-data">
                        @csrf
