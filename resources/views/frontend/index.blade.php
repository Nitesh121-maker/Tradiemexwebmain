...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="frontend/image/img/Favicon Logo.png"> @include('frontend.link')
...
<body> @include('frontend.header') <!-- Overview section -->
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="text-content"> <span>Overview</span>
                        ...
                        <p class="text-black" style="color:#fff"> TradeImeX is a leading global trade data provider,
                            ...
                            navigate the world of international trade with ease and confidence. </p>
                        <div class="btn-holder"> <a href="why-choose-us" class="ybtn ybtn-header-color">WHY CHOOSE US
                                ?</a> <a href="contact-us" class="ybtn ybtn-white ybtn-shadow ">Contact Us</a> </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="container-globe globe-responsive"> <canvas class="canvas-1"></canvas> </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 kp-width">
                    <div class="card-content cdh-16 bg-none">
                        <div class="icon"> <img src="frontend/image/img/reliable-data.png" width="25%"
                                style="padding: 0px 0px 0px 10px;"> </div>
                        <div class="head">
                            <h3 class="text-white">100% RELIABLE DATA</h3>
                        </div>
                        <p class="text-white" style="font-size: 14px;"> We promise to offer a 100% trustworthy database.
                            ...
                            business so that you can stay ahead. </p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 kp-width">
                    <div class="card-content cdh-16 bg-none">
                        <div class="icon"> <img src="frontend/image/img/updated-database.png" width="25%"
                                style="padding: 0px 0px 0px 10px;"> </div>
                        <div class="head">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 kp-width">
                    <div class="card-content cdh-17 bg-none">
                        <div class="icon"> <img src="frontend/image/img/reliability.png" width="25%"
                                style="padding: 0px 0px 0px 10px;"> </div>
                        <div class="head">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 kp-width">
                    <div class="card-content cdh-16 bg-none">
                        <div class="icon"> <img src="frontend/image/img/devaluation.png" width="25%"
                                style="padding: 0px 0px 0px 10px;"> </div>
                        <div class="head">
                        ...
                        <p class="text-white"> We offer services at extremely affordable rates. TradeImeX offers
                            ...
                            and export business in the world of global trade. </p>
                    </div>
                </div>
            </div>
        </div>
    </div> <!-- Search Live Import Export -->
    ...
    <!-- Data -->
    <div class="container-fluid bg-white padding-tb"> <!-- Import Export Overview -->
        <div class="container">
            <div class="text-content"> <span>Data</span>
                ...
                <p style="text-align: start;" class="lh-8"> TradeImeX is a gateway to a world of import-export data,
                    ...
                    TradeImeX offers unparalleled accuracy and comprehensiveness. </p>
            </div> <!-- Key Points -->
            <div class="row">
                <div class="text-content">
                    ...
                    <p> Find out how TradeImeX enables you to seize these possibilities and make the most of them on the
                        global market with our exclusive export-import data. </p>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                    <div class="card-content cdh-20">
                        <div class="icon"> <img src="frontend/image/img/exclusive-trade-data.png" width="25%"
                                style="padding: 0px 0px 0px 10px;"> </div>
                        <div class="head">
                        ...
                        <p> TradeImeX provides exclusive and easy-to-access global trade data. With our exclusive trade
                            ...
                            and gain valuable insights into market patterns and shifts. </p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                    <div class="card-content cdh-20">
                        <div class="icon"> <img src="frontend/image/img/intelligence-trade-data.png" width="25%"
                                style="padding: 0px 0px 0px 10px;"> </div>
                        <div class="head">
                        ...
                        <p> TradeImeX provides enterprises across many industries and regions with unparalleled access
                            ...
                            businesses with the data insights they need to succeed in the global marketplace. </p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                    <div class="card-content cdh-20">
                        <div class="icon"> <img src="frontend/image/img/Growth-I.png" width="25%"
                                style="padding: 0px 0px 0px 10px;"> </div>
                        <div class="head">
                        ...
                        <p> You can network with a variety of companies, firms, trade partners, manufacturers, and
                            ...
                            grow your business to previously unimaginable heights. </p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                    <div class="card-content cdh-20">
                        <div class="icon"> <img src="frontend/image/img/data-source.png" width="25%"
                                style="padding: 0px 0px 0px 10px;"> </div>
                        <div class="head">
    ...
    </div> <!-- End of import export data --> <!-- Product Tab -->
    <div class="container-fluid bg-dark-custom padding-tb">
        <div class="container">
            <div class="product-tab bg-dark-custom"> <button class="product-tablink active-1" id="btn-custom"
                    onclick="openLink(event, 'custom')"> <i class="fa-solid fa-file-pen fa-lg"></i> &nbsp;Custom Data
                        ...
                        class="fa-solid fa-magnifying-glass-chart fa-lg"></i> &nbsp;Statistical Data </button> <button
                    class="product-tablink" id="btn-bl" onclick="openLink(event, 'bl')"> <i
                        class="fa-solid fa-chart-simple fa-lg"></i> &nbsp;B/L Data </button> </div> <!-- Custom -->
            <div id="custom" class="product-tabcontent bg-dark-custom" style="display:flex">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12" style="display: flex;align-items: center;">
                        <div class="data-img"> <img src="frontend/image/img/Customs_Data.png"
            ...
            <div id="stat" class="product-tabcontent bg-dark-custom">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12" style="display: flex;align-items: center;">
                        <div class="data-img"> <img src="frontend/image/img/Statistical Data.png"
            ...
            <div id="bl" class="product-tabcontent bg-dark-custom">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12" style="display: flex;align-items: center;">
                        <div class="data-img"> <img src="frontend/image/img/Bill of Ladding Database.png"
                                style="width: 100% !important" alt="bl-data | TradeImeX"> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 text-center">
                    <div class="text-content">
                        ...
                        <p class="lh-8"> TradeImeX provides firms from all sectors and locations with access to
                            international trade data, exceeding your expectations. </p>
    ...
    <div class="container-fluid bg-dark-custom padding-tb">
        <div class="container">
            <div class="tab"> <button class="tablinks active-1"
                    onmouseover="openCity(event, 'Asia')">Asia</button> <button class="tablinks"
                    onmouseover="openCity(event, 'Africa')">Africa</button> <button class="tablinks"
                    onmouseover="openCity(event, 'America')">America</button> <button class="tablinks"
                    onmouseover="openCity(event, 'Europe')">Europe</button> <button class="tablinks"
                    onmouseover="openCity(event, 'Oceania')">Oceania</button> </div> <!-- Asia AS-24 -->
            <div id="Asia" class="tabcontent" style="display: block !important;">
                <div class="container" style="padding-left: 10%;">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3 col-lg-3 Flag"> <img src="frontend/image/flags/bangladesh.png">
                            <br>
            ...
            <div id="Africa" class="tabcontent">
                <div class="container" style="padding-left: 10%;">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3 col-lg-3 Flag"> <img
                                src="frontend/image/flags/botswana_rectangular_icon_with_shadow_64.png"> <br>
                            @foreach ($countrydata as $country)
            ...
            <div id="America" class="tabcontent"> <!-- North America NA-8 -->
                <div class="container" style="padding-left: 10%;">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3 col-lg-3 Flag"> <img
                                src="frontend/image/flags/canada_rectangular_icon_with_shadow_64.png"> <br>
                            @foreach ($countrydata as $country)
                ...
                <div class="container" style="padding-left: 10%;">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3 col-lg-3 Flag"> <img
                                src="frontend/image/flags/argentina_rectangular_icon_with_shadow_64.png"> <br>
                            @foreach ($countrydata as $country)
            ...
            <div id="Europe" class="tabcontent">
                <div class="container" style="padding-left: 10%;">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3 col-lg-3 Flag"> <img
                                src="frontend/image/flags/austria_rectangular_icon_with_shadow_64.png"> <br>
                            @foreach ($countrydata as $country)
            ...
            <div id="Oceania" class="tabcontent">
                ...
                <div class="container" style="padding-left: 10%;">
                    <div class="row">
                        <div class="col-sm-4 col-md-3 col-lg-3 Flag"> <img
                                src="frontend/image/flags/australia_rectangular_icon_with_shadow_64.png"> <br>
                            @foreach ($countrydata as $country)
        ...
        <div class="text-content flex" style="justify-content: center;margin-top: 2rem;">
            ...
            <div class="flex text-center" style="align-items: baseline;padding: 2px 15px 2px 4px;"> <i
                    class="fa-solid fa-square" style="color: #fff;"></i>
                <p class="text-black text-white">&nbsp;&nbsp;Statistical/BL Data</p>
            </div>
        </div>
    </div> <!-- End Of Countries List --> <!-- Client floating list -->
                ...
                <div class="col-sm-12 col-md-12 col-lg-6"> <!-- For Desktop, laptop, tablet & big screen -->
                    <div id="anim" class="PartnersHeroGraphic" data-js-controller="PartnersHeroGraphic">
                        <div class="PartnersHeroGraphicLogo" data-js-controller="PartnersHeroGraphicLogo"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    id="logoss" src="frontend/image/clients/BASF.png" width="70"
                                    height="70"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo" data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="lightblue"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/client_transparent/Deloitte.png" width="70"
                                    height="70"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo PartnersHeroGraphicLogo--sage"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/dow.png" width="70" height="30"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo" data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="mauve"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/EY.png" width="50" height="40"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo" data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="blue"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/client_transparent/Hyundai.png" width="120"
                                    height="70"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo" data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="green"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/IDC.png" width="60" height="50"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo" data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="lightblue"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/imerys.png" width="70" height="50"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo" data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="mauve"
                            style="--partnersHeroGraphicLogoBackground:#E2E2E2; transform: translate3d(12.4008px, 187px, 0px); transition: all 0.8s ease 0s;">
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/itochu.png" width="70" height="30"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo " data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="purple"
                            style="--partnersHeroGraphicLogoBackground:#E2E2E2; transform: translate3d(550px, -120px, 0px); transition: all 0s ease 0s;">
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/kpmg-logo-1.png" width="70" height="50">
                            </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo Tradeimex+9:0 pos:0"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/LG.png" width="70" height="70"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo " data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="black"
                            style="--partnersHeroGraphicLogoBackground:#E2E2E2; transform: translate3d(550px, -120px, 0px); transition: all 0s ease 0s;">
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/Mahindra.png" width="50" height="30">
                            </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo Tradeimex+10:1 pos:1"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/Marubeni.png" width="70" height="70">
                            </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo Tradeimex+11:2 pos:2"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/Mitsubishi.png" width="60" height="60">
                            </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo vivian+12:3 pos:3"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/Nikon.png" width="70" height="70"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo Tradeimex+13:4 pos:4"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/Realme.png" width="60" height="40"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo Tradeimex+15:6 pos:6"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/samsung.png" width="80" height="80"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo Tradeimex+14:5 pos:5"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/shimadzu.png" width="70" height="70">
                            </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo " data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="lightblue"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/Superdry.png" width="70" height="30">
                            </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo " data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="lightblue"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/Tata.png" width="120" height="90"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo " data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="blue"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/Thermax.png" width="60" height="40"> </div>
                        </div>
                        <div class="PartnersHeroGraphicLogo " data-js-controller="PartnersHeroGraphicLogo"
                            data-shade="darkblue"
                            ...
                            <div class="PartnersHeroGraphicLogo__wrapper"
                                data-js-target="PartnersHeroGraphicLogo.wrapper" style="opacity: 1;"> <img
                                    src="frontend/image/clients/TVS.png" width="70" height="60"> </div>
                        </div>
                    </div> <!-- For Mobile -->
                        ...
                        <div class="row">
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img
                                        src="frontend/image/client_transparent/Realme.png"> </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img
                                        src="frontend/image/client_transparent/Nikon.png"> </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img
                                        src="frontend/image/client_transparent/Samsung.png"> </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img src="frontend/image/client_transparent/LG.png">
                                </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img
                                        src="frontend/image/client_transparent/Hyundai.png"> </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img
                                        src="frontend/image/client_transparent/Mahindra.png"> </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img src="frontend/image/client_transparent/Tata.png">
                                </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img src="frontend/image/client_transparent/TVS.png">
                                </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img
                                        src="frontend/image/client_transparent/Deloitte.png"> </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img
                                        src="frontend/image/client_transparent/Reckitt_Benckiser.png"> </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img src="frontend/image/client_transparent/Dow.png">
                                </div>
                            </div>
                            <div class="client-mb col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="client-img zoom"> <img src="frontend/image/client_transparent/KPMG.png">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    </div> <!-- End of Client floating list --> <!-- Blog slider -->
    ...
    <div class="container pdt-2">
        @if (session('blogerror'))
                ...
                <div class="row">
                    @foreach ($recentPosts as $post)
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="blog_card">
                                <div class="blog_card_image"> <img
                                        src="https://tradeimex.in/blogs/{{ $post->image_big }}" alt="">
                                </div>
                                <div class="blog_card_content">
                                    <h3>{{ $post->title }}</h3>
                                    <p>{{ Str::limit($post->summary, 150) }}</p>
                                </div>
                                <div class="container"> <a class="text-hover"
                                        href="https://tradeimex.in/blogs/{{ $post->title_slug }}">
                                        <h6>Read More</h6>
                                    </a> </div>
                            </div>
                        </div>
            ...
            @endif
    </div> <!-- Last Contact Us --> @include('frontend.tab_inc') @include('frontend.footer')
    @include('frontend.script') <!-- Flag JS -->
    <script>
