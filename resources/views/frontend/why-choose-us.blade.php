                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="card card-bg">
                            <div class="card-img">
                                <img src="/frontend/image/img/accurate.png" class="card-img-top" alt="..." style="width: 25%;">
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="card card-bg">
                            <div class="card-img">
                                <img src="/frontend/image/img/updated-database.png" class="card-img-top" alt="..." style="width: 25%;">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title text-white" style="font-size: 18px;font-weight: 600;">
                                    UPDATED DATABASE
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="card card-bg">
                            <div class="card-img">
                                <img src="/frontend/image/img/exclusive-reports.png" class="card-img-top" alt="..." style="width: 25%;">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title text-white" style="font-size: 18px;font-weight: 600;">
                                    EXCLUSIVE REPORTS
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="card card-bg">
                            <div class="card-img">
                                <img src="/frontend/image/img/pocket-friendly.png" class="card-img-top" alt="..." style="width: 25%;">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title text-white" style="font-size: 18px;font-weight: 600;">
                                    POCKET FRIENDLY
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="card card-bg cdh-20">
                                <div class="card-img">
                                    <img src="/frontend/image/img/accurate-data.png" class="card-img-top" alt="..." style="width: 25%;">
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title text-white" style="font-size: 18px;font-weight: 600;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="card card-bg cdh-20">
                                <div class="card-img">
                                    <img src="/frontend/image/img/recent-database.png" class="card-img-top" alt="..." style="width: 25%;">
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title text-white" style="font-size: 18px;font-weight: 600;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="card card-bg cdh-20">
                                <div class="card-img">
                                    <img src="/frontend/image/img/data-sourcing.png" class="card-img-top" alt="..." style="width: 25%;">
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title text-white" style="font-size: 18px;font-weight: 600;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="card card-bg cdh-20">
                                <div class="card-img">
                                    <img src="/frontend/image/img/tracking.png" class="card-img-top" alt="..." style="width: 25%;">
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title text-white" style="font-size: 18px;font-weight: 600;">
